...
* If a resource block overlaps `sync_pos` or `pilot_positions`, the built-in sync / pilot RE still win. Priority is `sync symbol > pilot > sensing_pilot > payload/random QPSK`.
